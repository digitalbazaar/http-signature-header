export const signatureInputs = {
  date: 'sig1=("date");keyid="foo";alg="bar"',
  requestTarget: 'sig1=("date" "@request-target")' +
    ';keyid="foo";alg="bar"',
...
export const signatures = {
  exampleOne: 'sig1=:qGKjr1213+iZCU1MCV8w2NTr/HvMGWYDzpqAWx7SrPE1y6gOkIQ3k2' +
