 ...
 * @property {Object} options.includeHeaders - A list of covered content.
 * @property {Object} options.requestOptions - A request with headers &
 *   a method.
 *
...
api.parseRequest = (request, options) => {
  ...
  if(!parsed.params.headers) {
    // latest spec specifies this as the default headers
